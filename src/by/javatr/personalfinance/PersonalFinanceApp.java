...
public class PersonalFinanceApp {
    ...
    public static void main(String[] args) {
        ...
        String getAccountResponse = controller.executeCommand("GET_ACCOUNT login:Bob, account_id:1");
        System.out.println(getAccountResponse);
        String getAccountListResponse = controller.executeCommand("GET_ACCOUNT_LIST login:Bob");
        System.out.println(getAccountListResponse);
        controller.executeCommand("GET_BALANCE login:Bob, account_name:wallet");
        controller.executeCommand("GET_COMMON_BALANCE login:Bob");
